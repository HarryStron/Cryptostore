...
//        try {
//            byte[] filebytes = EncryptionManager.encryptFile("password".toCharArray(), Paths.get("test.txt"));
//            FileOutputStream fos = new FileOutputStream("testEncrypted.txt");
//            fos.write(filebytes);
//            fos.close();
//
//            byte[] filebytes2 = EncryptionManager.decryptFile("password".toCharArray(), Paths.get("testEncrypted.txt"));
