...
public class TransferManager {
    ...
    public TransferManager(SSLSocket socket) throws Exception {
        try {
            ...
            throw new Exception(com.cryptostore.Error.CANNOT_CONNECT.getDescription());
        }
    }
    ...
    public void writeControl(Command command) throws Exception {
        try {
            ...
            throw new Exception(com.cryptostore.Error.FAILED_TO_WRITE.getDescription());
        }
    }
    ...
    public Packets read(long sizeOfFile) throws Exception {
        try {
            ...
            throw new Exception(com.cryptostore.Error.FAILED_TO_READ.getDescription());
        }
    }
    ...
    public void closeStreams() throws Exception {
        try {
            ...
            throw new Exception(com.cryptostore.Error.FAILED_TO_CLOSE_STREAMS.getDescription());
        }
    }
